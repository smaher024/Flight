...
<div style="max-width: 650px; margin: 0 auto; padding: 40px 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.8; color: #e1e1e1; background-color: #0d1117;">
  ...
  <!-- Second Image -->
  <div style="text-align: center; margin-bottom: 40px;">
    <img src="2_Amber.png" alt="Amber" style="max-width: 100%; height: auto; border-radius: 4px; display: inline-block;">
  </div>

  <!-- Story Paragraphs with Clean Breathing Room -->
  ...
  <!-- Dramatic Mid-Point -->
  <p style="text-align: center; font-style: italic; font-size: 1.2em; margin-top: 40px; margin-bottom: 40px; color: #8b949e;">
    Amber.
  </p>
